#!/bin/bash
# Voice Stack TTS Service Uninstallation Script
#
# This script removes the Voice Stack TTS service from systemd.
# It does NOT remove the repository files or virtual environment.
#
# Usage:
#   sudo ./uninstall-tts.sh            # Uninstall system service
#   ./uninstall-tts.sh                  # Uninstall user service
#
...
# Print banner
echo "=========================================="
echo "Voice Stack TTS Service Uninstallation"
echo "=========================================="
echo ""
...
log_info "You can reinstall the service later with: ./scripts/install-tts.sh"
echo ""
